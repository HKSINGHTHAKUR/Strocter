    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center section-padding overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-[0.03]"
          style={{
            backgroundImage: `
              linear-gradient(color-mix(in srgb, var(--color-foreground) 30%, transparent) 1px, transparent 1px),
              linear-gradient(90deg, color-mix(in srgb, var(--color-foreground) 30%, transparent) 1px, transparent 1px)
            `,
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        >
          <button
            ...
            className="group relative px-12 py-5 rounded-full bg-primary text-primary-foreground font-medium tracking-wide text-sm transition-all duration-500 hover:px-16 hover:shadow-[0_0_60px_-10px_color-mix(in_srgb,var(--color-primary)_60%,transparent)]"
          >
