export default function TopNav() {
    return (
        <header className="topnav fixed top-0 left-[72px] right-0 z-20 flex items-center justify-between px-8">
            {/* Left: Title */}
            <div>
                <h2 className="text-sm font-semibold tracking-wide text-text-secondary">CONTROL CENTER</h2>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2 bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-2">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="bg-transparent outline-none text-sm text-text-secondary placeholder-text-muted w-40"
                    />
                </div>
                ...
                <button className="relative p-2 text-text-muted hover:text-white transition-colors cursor-pointer">
                    ...
                    <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-accent-orange rounded-full"></span>
                </button>
