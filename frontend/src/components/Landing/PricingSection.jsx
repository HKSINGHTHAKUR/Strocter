        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {plans.map((plan, i) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-8 md:p-10 transition-all duration-500 ${plan.isPremium
            ...
            >
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-medium text-sm tracking-wide transition-all duration-300 ${plan.isPremium
